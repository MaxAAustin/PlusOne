...
public class LoginActivity extends AppCompatActivity {
    ...
    void connectFacebook() {
        ...
        SimpleAuth.getInstance().connectFacebook(scopes, new AuthCallback() {
            ...
            public void onSuccess(SocialUser socialUser) {
                MainActivity.start(LoginActivity.this, FACEBOOK, socialUser);
            }
    ...
    void connectGoogle() {
        ...
        SimpleAuth.getInstance().connectGoogle(scopes, new AuthCallback() {
            @Override
            public void onSuccess(SocialUser socialUser) {
                MainActivity.start(LoginActivity.this, GOOGLE, socialUser);
            }
    ...
    void connectTwitter() {
        SimpleAuth.getInstance().connectTwitter(new AuthCallback() {
            @Override
            public void onSuccess(SocialUser socialUser) {
                MainActivity.start(LoginActivity.this, TWITTER, socialUser);
            }
    ...
    void connectInstagram() {
        ...
        SimpleAuth.getInstance().connectInstagram(scopes, new AuthCallback() {
            @Override
            public void onSuccess(SocialUser socialUser) {
                MainActivity.start(LoginActivity.this, INSTAGRAM, socialUser);
            }
